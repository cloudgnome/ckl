...
def ttn(request):
    ...
    for seat_data in request_data['seats']:
        volumetricHeight = seat_data.get('volumetricHeight')
        volumetricWidth = seat_data.get('volumetricWidth')
        volumetricLength = seat_data.get('volumetricLength')
        ...
        Volume = (int(volumetricHeight) * int(volumetricWidth) * int(volumetricLength)) / 4000
        ...
        if Volume > 2 and (int(volumetricHeight) > 40 or int(volumetricWidth) > 40 or int(volumetricLength) > 40):
