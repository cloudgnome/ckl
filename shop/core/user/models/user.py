...
class User(models.Model):
    ...
    name = models.CharField(max_length=255,blank=False,null=True,verbose_name='Имя')
    lname = models.CharField(max_length=255,blank=False,null=True,verbose_name='Фамилия')
    sname = models.CharField(max_length=255,blank=False,null=True,verbose_name='Отчество')
    phone = models.CharField(max_length=16,verbose_name='Номер телефона', null=True)
    password = models.CharField(verbose_name='password', max_length=128)
    is_active = models.BooleanField(verbose_name='active', default=True)
    is_admin = models.BooleanField(default=False)
    subscription = models.BooleanField(verbose_name='Подписка на рассылку',default=True)
    price_type_choices = (
        (1,'Розничная'),
        (2,'Биг-оптовая'))
    price_type = models.PositiveIntegerField(choices=price_type_choices,default=1,verbose_name="Тип цен")
    last_login = models.DateTimeField(auto_now_add=True,verbose_name="Последний раз на сайте",null=True)
