...
shop_settings = Settings.objects.values('attention_message','phones','emails','google_analytics','google_tag','google_verification').first()
...
def default(request):
    ...
    if not request.is_ajax():
        ...
        context['EMAIL'] = shop_settings.get('emails')
        ...
        if slug:
            ...
            try:
                ...
                if request.user.is_admin:
                    context['edit_url'] = '%s/edit/%s/%s' % (ADMIN_BASE_URL,slug.model.lower(),obj.id)
