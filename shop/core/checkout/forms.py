...
class CheckoutForm(forms.ModelForm):
    ...
    delivery_type = forms.CharField(label=_('Способ доставки*'),widget=SelectWithDisabled(attrs={'class': 'customSelect','autocomplete':'off'},choices=delivery_choices),required=True)
    payment_type = forms.CharField(label=_('Способ оплаты*'),widget=SelectWithDisabled(attrs={'class': 'customSelect','autocomplete':'off'},choices=payment_choices),required=True)
